    ...
    rows: [
        {
            ...
            with a user base of over 170 million travellers. LocoPass is used for deal discovery, personalized recommendations, dynamic marketing, airfare predictions, train delay information, PNR confirmation status, infrastructure cost optimization, 
        ...
        },
        {
            ...
            content:<ul><li style={{color:'grey'}}>Please follow these simple steps to cancel your ticket on LocoPass</li>
